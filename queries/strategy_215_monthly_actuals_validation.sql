...
stored_actuals AS (
    ...
    FROM base_pricing.bp_monthly_forecast_actuals mfa
    WHERE mfa.strategy_id = 215
),
...
actuals_granular_monthly AS (
    ...
    INNER JOIN base_pricing.bp_transaction_data_monthly tm
...
actuals_granular_daily AS (
    ...
    INNER JOIN base_pricing.bp_transaction_data_daily td
